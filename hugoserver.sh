...
docker run -tip 1313:1313 -v $(pwd):/home/circleci/project:cached -e HUGO_BASEURL=hyde-x --name hugo-server --entrypoint "" cibuilds/hugo:0.67.0 hugo server --watch --bind ""
